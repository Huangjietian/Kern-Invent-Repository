...
import cn.kerninventor.tools.poibox.data.tabulation.element.Anchor;
import cn.kerninventor.tools.poibox.data.tabulation.element.Margins;
import cn.kerninventor.tools.poibox.data.tabulation.element.Palette;
...
public final class LayoutHandler extends BoxBracket implements Layouter {
    ...
    public void addTextBox(Sheet sheet, Textbox textbox) {
        ...
        cn.kerninventor.tools.poibox.data.tabulation.element.Palette fillColor = textbox.fillColor();
