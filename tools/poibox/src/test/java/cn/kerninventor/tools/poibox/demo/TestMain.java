...
public class TestMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //读取流中的数据
        List<NewTestBO> readList = dataTabulator.reader(NewTestBO.class).readFrom("人员信息导入模板2");
        System.out.println("读取的数据总量： "+ readList.size());

        //打开本地文件的数据读取形式
        try {
            POIBox newBox = POIBoxFactory.open("C:\\Users\\82576\\Desktop\\人员信息导入模板.xls");
            List<NewTestBO> readList2 = newBox.dataTabulator().reader(NewTestBO.class).readFrom("人员信息导入模板2");
