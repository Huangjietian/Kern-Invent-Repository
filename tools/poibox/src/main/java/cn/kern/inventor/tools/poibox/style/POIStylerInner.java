...
public class POIStylerInner extends POICreator implements POIStyler {
    ...
    @Override
    public POIStyler setBorder(CellDirection direction, BorderLine borderLine) {
        switch (direction){
            case TOP :
    ...
    @Override
    public POIStyler setBorderColor(CellDirection direction, HSSFColor color) {
        switch (direction){
            case TOP :
    ...
    @Override
    public POIStyler setFillPattern(FillPattern fillPattern) {
    ...
    @Override
    public POIStyler setVerticalAlignment(Vertical vertical) {
        cellStyle.setVerticalAlignment(vertical.getIndex());
        return this;
    }

    @Override
    public POIStyler setAlignment(Align align) {
    ...
    public POIStyler setWholeCenter() {
        setVerticalAlignment(Vertical.VERTICAL_CENTER).setAlignment(Align.ALIGN_CENTER);
        return this;
    }
    ...
    public CellStyle commonHeadLine(Integer fontSize) {
        return new POIStylerInner(getParent())
                .setWholeCenter()
                .setBorder(CellDirection.SURROUND, BorderLine.BORDER_THIN)
                .setFont(
