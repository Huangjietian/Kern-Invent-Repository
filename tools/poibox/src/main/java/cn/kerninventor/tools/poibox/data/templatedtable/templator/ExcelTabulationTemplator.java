...
public class ExcelTabulationTemplator<T> implements Templator<T>, InstanceGetter<ExcelTabulationInitializer<T>> {
    ...
    @Override
    public void wirteTo(String sheetName, List<T> datas) {
        new ExcelTabulationWriter<T>().writeTo(sheetName, datas, this);
    }

    @Override
    public void wirteTo(int sheetAt, List<T> datas) {
        new ExcelTabulationWriter<T>().writeTo(sheetAt, datas, this);
    }

    @Override
    public void wirteTo(Sheet sheet, List<T> datas) {
