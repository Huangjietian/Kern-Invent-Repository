package cn.kerninventor.tools.poibox.data.datatable.validation.decimal;
...
public class ExcelDecimalValidHandler implements DataValidHandler<ExcelValid_DECIMAL> {
    ...
    @Override
    public void addValidation(DataTabulation dataTabulation, DataColumn dataColumn, Sheet sheet, ExcelValid_DECIMAL excelValid) {
    ...
    private void annotationValid(DataColumn dataColumn, ExcelValid_DECIMAL excelValid) {
